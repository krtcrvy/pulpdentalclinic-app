                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm h-100">
                        <div class="card-body d-flex justify-content-between align-items-center flex-column p-5">
                            ...
                            <p>We've got you covered with personalized cleanings, painless fillings, crowns, dentures, and
                                bridges.</p>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm h-100">
                        <div class="card-body d-flex justify-content-between align-items-center flex-column p-5">
                            ...
                            <p>Expert surgical care from the team you know and trust. Implants, canals, extractions and
                                more.
                            </p>
                            <button type="button" class="w-100 btn btn-lg btn-primary">Learn more</button>
                        </div>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm h-100">
                        <div class="card-body d-flex justify-content-between align-items-center flex-column p-5">
                            ...
                            <p>We'll help you understand high-tech cosmetic options, like Invisalign, veneers, teeth
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm h-100">
                        <div class="card-body d-flex justify-content-between align-items-center flex-column p-5">
                            ...
                            <p>Led by Dr. Raul Arganza, our team is proud to offer a fresh take on going to the dentist in
                                Liberty.</p>
                            <button type="button" class="w-100 btn btn-lg btn-primary">Learn more</button>
                        </div>
                    </div>
